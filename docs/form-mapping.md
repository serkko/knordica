...
| `condition` | `condition` | `TEXT` | Sí | Conservación: 'nuevo', 'excelente', 'buen_estado', 'por_remodelar', 'en_gris'. |
| `furnished` | `furnished` | `TEXT` | Sí | `DEFAULT 'sin_muebles'`. Opciones: 'sin_muebles', 'semi_amoblado', 'amoblado'. |
...
| `gas_type` | `gas_type` | `TEXT` | Sí | Opciones: 'central', 'bombona', 'no_tiene'. |
...
| `kitchen_type` | `kitchen_type` | `TEXT` | Sí | Opciones: 'gas', 'electrica', 'induccion', 'mixta', 'no_tiene'. |
