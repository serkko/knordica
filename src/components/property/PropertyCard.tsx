          ...
          <div>
            ...
            <div className="flex items-center justify-between mt-2 pt-1">
              ...
              <Link
                ...
                className="text-xs font-semibold uppercase tracking-wider font-display text-[var(--text-2)] hover:text-[var(--accent)] transition-colors flex items-center gap-1"
              >
